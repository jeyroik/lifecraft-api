...
class RepositoryDangers extends Repository
{
    protected $table = null;
    protected string $name = 'dangers';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\dangers\Danger';
    protected string $repoSubject = 'dangers';
