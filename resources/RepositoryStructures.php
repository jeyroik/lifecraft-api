...
class RepositoryStructures extends Repository
{
    protected $table = null;
    protected string $name = 'structures';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\structures\Structure';
    protected string $repoSubject = 'structures';
