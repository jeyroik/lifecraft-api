...
class RepositoryAvatars extends Repository
{
    protected $table = null;
    protected string $name = 'avatars';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\avatars\Avatar';
    protected string $repoSubject = 'avatars';
