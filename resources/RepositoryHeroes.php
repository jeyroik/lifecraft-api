...
class RepositoryHeroes extends Repository
{
    protected $table = null;
    protected string $name = 'heroes';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\heroes\Hero';
    protected string $repoSubject = 'heroes';
    ...
    {
        \lifecraft\components\UUid::generateFor($item);\lifecraft\components\repositories\IsExist::check($this, $item, ['name']);
