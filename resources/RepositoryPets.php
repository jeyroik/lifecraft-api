...
class RepositoryPets extends Repository
{
    protected $table = null;
    protected string $name = 'pets';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\pets\Pet';
    protected string $repoSubject = 'pets';
