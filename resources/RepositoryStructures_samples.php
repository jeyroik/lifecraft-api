...
class RepositoryStructures_samples extends Repository
{
    protected $table = null;
    protected string $name = 'structures_samples';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\structures\StructureSample';
    protected string $repoSubject = 'structures_samples';
