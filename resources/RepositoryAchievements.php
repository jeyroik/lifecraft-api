...
class RepositoryAchievements extends Repository
{
    protected $table = null;
    protected string $name = 'achievements';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\achievements\Achievement';
    protected string $repoSubject = 'achievements';
