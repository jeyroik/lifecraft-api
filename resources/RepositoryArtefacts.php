...
class RepositoryArtefacts extends Repository
{
    protected $table = null;
    protected string $name = 'artefacts';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\artefacts\Artefact';
    protected string $repoSubject = 'artefacts';
