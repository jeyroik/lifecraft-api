...
class RepositoryRanks_samples extends Repository
{
    protected $table = null;
    protected string $name = 'ranks_samples';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\ranks\RankSample';
    protected string $repoSubject = 'ranks_samples';
