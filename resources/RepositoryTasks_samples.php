...
class RepositoryTasks_samples extends Repository
{
    protected $table = null;
    protected string $name = 'tasks_samples';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\tesks\TaskSample';
    protected string $repoSubject = 'tasks_samples';
