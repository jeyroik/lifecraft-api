...
class RepositoryPets_samples extends Repository
{
    protected $table = null;
    protected string $name = 'pets_samples';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\pets\PetSample';
    protected string $repoSubject = 'pets_samples';
