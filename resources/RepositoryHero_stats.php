...
class RepositoryHero_stats extends Repository
{
    protected $table = null;
    protected string $name = 'hero_stats';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\hero\HeroStat';
    protected string $repoSubject = 'hero_stats';
