...
class RepositoryArtefacts_samples extends Repository
{
    protected $table = null;
    protected string $name = 'artefacts_samples';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\artefacts\ArtefactSample';
    protected string $repoSubject = 'artefacts_samples';
