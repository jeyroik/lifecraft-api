...
class RepositoryRanks extends Repository
{
    protected $table = null;
    protected string $name = 'ranks';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\ranks\Rank';
    protected string $repoSubject = 'ranks';
