...
class RepositoryDangers_samples extends Repository
{
    protected $table = null;
    protected string $name = 'dangers_samples';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\dangers\DangerSample';
    protected string $repoSubject = 'dangers_samples';
