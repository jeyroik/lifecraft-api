...
class RepositoryHeroes_samples extends Repository
{
    protected $table = null;
    protected string $name = 'heroes_samples';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\heroes\HeroSample';
    protected string $repoSubject = 'heroes_samples';
