...
class RepositoryStories_samples extends Repository
{
    protected $table = null;
    protected string $name = 'stories_samples';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\stories\StorySample';
    protected string $repoSubject = 'stories_samples';
