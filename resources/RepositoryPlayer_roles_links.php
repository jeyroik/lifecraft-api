...
class RepositoryPlayer_roles_links extends Repository
{
    protected $table = null;
    protected string $name = 'player_roles_links';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\players\PlayerRoleLink';
    protected string $repoSubject = 'player_roles_links';
