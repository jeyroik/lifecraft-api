...
class RepositoryAchievements_samples extends Repository
{
    protected $table = null;
    protected string $name = 'achievements_samples';
    protected string $scope = 'extas';
    protected string $pk = 'name';
    protected string $itemClass = '\lifecraft\components\achievements\AchievementSample';
    protected string $repoSubject = 'achievements_samples';
    ...
    {
        \lifecraft\components\UUid::generateFor($item);
